...
public class IndexController {
    ...
    public ModelAndView getIndex(HttpSession session) {
        session.setAttribute("js", "../../../js/login.js");
    ...
    public ChatUserDto getChatUserLinkForSendingCredentials() throws NoSuchMethodException, JsonProcessingException {
        Method verifyLoginMethod = IndexController.class.getMethod("verifyLogin", ChatUserDto.class, HttpSession.class);
        Link verifyLoginLink = ControllerLinkBuilder.linkTo(IndexController.class, verifyLoginMethod).withSelfRel();
